...
public class Equipo {
    ...
    public Equipo(int id_equipo, int id_cliente, String tipo_equipo, String marca, String modelo, String num_serie, String dia_ingreso, String mes_ingreso, String annio_ingreso, String observaciones, String estatus, String ultima_modificacion, String comentarios_tecnicos, String revision_tecnica_de) {
    ...
    public Equipo(int id_equipo, String tipo_equipo, String marca, String estatus) {
        this.id_equipo = id_equipo;
        this.tipo_equipo = tipo_equipo;
        this.marca = marca;
        this.estatus = estatus;
    ...
    public Equipo(int id_cliente, String tipo_equipo, String marca, String modelo, String num_serie, String dia_ingreso, String mes_ingreso, String annio_ingreso, String observaciones, String estatus, String ultima_modificacion) {
        this.id_cliente = id_cliente;
        this.tipo_equipo = tipo_equipo;
        this.marca = marca;
        this.modelo = modelo;
